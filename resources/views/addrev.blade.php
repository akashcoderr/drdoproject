...
<div class="container">
    <div class="row">
        <div class="col-sm-6"> 
            <form action="/revadd" method="post">
            @csrf
            <div class="form-group">
                <label for="">BilL Number</label>
                <input type="text" required name="bill_no" class="form-control" id="" aria-describedby="" placeholder="Enter Bill Number">
            </div>
            <div class="form-group">
                <label for="">Bill Date</label>
                <input type="date" required name="bill_date" class="form-control" id="" aria-describedby="" placeholder="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="bil_head" required class="form-control" id="" aria-describedby="" placeholder="Enter Bill Head">
            </div>
            <div class="form-group">
